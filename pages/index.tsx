						...
						<div className="mx-auto mt-16 flex max-w-6xl items-start">
							...
							<div>
								<p className="flex items-center text-center text-gray-500 lg:mx-8">
									...
									Aperiam, quam. Odio voluptatem
									officiis eos illo! Pariatur, totam
									alias. Beatae accusamus earum quos
									obcaecati minima molestias.
									Possimus minima dolores itaque!
									Esse! Lorem ipsum dolor sit amet
									consectetur adipisicing elit. Ea
									voluptates fugiat corrupti
									laudantium dolores reiciendis
									pariatur esse quod nihil quia
									cupiditate debitis quisquam nemo,
					...
					<div className="container mx-auto px-6 py-10">
						<div className="text-center">
							...
							<p className="mx-auto mt-4 max-w-lg text-gray-500">
								Salami mustard spice tea fridge
								authentic Chinese food dish salt tasty
						...
						<div className="mt-8 grid grid-cols-1 gap-8 md:mt-16 md:grid-cols-2 xl:grid-cols-3">
							<div>
								...
								<p className="text-sm text-gray-500 dark:text-gray-400">
									Lorem ipsum dolor sit amet
									consectetur adipisicing elit.
									Blanditiis fugit dolorum amet
									dolores praesentium, alias nam?
									Tempore
								</p>
							...
							<div>
								...
								<h1 className="mt-6 text-xl font-semibold text-gray-800 dark:text-white">
									Which services you get from Meraki
									UI
								</h1>
				...
				<div className="bg-white dark:bg-gray-900">
					<div className="container mx-auto px-6 py-8">
						...
						<p className="mx-auto mt-4 max-w-2xl text-center text-gray-500 dark:text-gray-300 xl:mt-6">
							Lorem ipsum, dolor sit amet consectetur
							adipisicing elit. Alias quas magni libero
							consequuntur voluptatum velit amet id
							repudiandae ea, deleniti laborum in neque
							eveniet.
						</p>
						...
						<div className="mt-12 space-y-8">
							<div className="rounded-lg border-2 border-gray-100 dark:border-gray-700">
								...
								<p className="p-8 text-sm text-gray-500 dark:text-gray-300">
									Lorem ipsum dolor sit, amet
									consectetur adipisicing elit.
									Voluptas eaque nobis, fugit odit
									omnis fugiat deleniti animi ab
									maxime cum laboriosam recusandae
									facere dolorum veniam quia pariatur
